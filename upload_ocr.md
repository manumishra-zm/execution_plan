...
**Legend:**
- 🟢 Green = Free (local parsers, instant)
- 🔵 Blue = Free (local OCR - PaddleOCR/Surya)
- 🟡 Yellow = Hybrid (local + Gemini fallback)
- 🔴 Pink = Multi-OCR (all engines + verification)
...
flowchart TB
    ...
    style FileProcessing fill:#F0FFF0
    style OCR fill:#FFE4E1
...
flowchart TB
    ...
    style UserActions fill:#E6F3FF
    style Upload fill:#F0FFF0
    style Chat fill:#FFF8DC
    style Display fill:#FFE4E1
```
